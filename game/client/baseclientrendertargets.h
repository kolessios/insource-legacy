...
protected:
    ...
    CTextureReference m_GlassReflectionTexture[MAX_REFLECTIONS];
    CTextureReference m_GlassRefractionTexture[MAX_REFLECTIONS];
    ...
    void CreateGlassReflectionTextures( IMaterialSystem* pMaterialSystem, int iSize = 2048 );
    void CreateGlassRefractionTextures( IMaterialSystem* pMaterialSystem, int iSize = 2048 );
