...
//	RecvPropArray( RecvPropInt( RECVINFO(m_cellXY[0]) ), m_cellXY ),
    ...
    RecvPropInt( RECVINFO( m_iVisibilityExclusivity ) ),
...
//	m_vecAbsAngVelocity.Init();
    ...
    m_iVisibilityExclusivity = VISIBILITY_EXCLUSIVE_NONE;
...
bool C_BaseEntity::ShouldDraw()
{
    ...
    // Solo queremos mostrar en reflejos/sombras, forzamos.
    if ( m_iVisibilityExclusivity > VISIBILITY_EXCLUSIVE_NONE )
        return true;

    // Esta marcado como invisible
