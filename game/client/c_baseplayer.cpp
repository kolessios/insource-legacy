...
BEGIN_PREDICTION_DATA( C_BasePlayer )
	...
	DEFINE_PRED_FIELD_TOL( m_flMaxspeed, FIELD_FLOAT, FTYPEDESC_INSENDTABLE, 1.0f ),
...
bool C_BasePlayer::ShouldDrawLocalPlayer()
{
	...
	return input->CAM_IsThirdPerson(nSlot) || ( ToolsEnabled() && ToolFramework_IsThirdPersonCamera() );
}
