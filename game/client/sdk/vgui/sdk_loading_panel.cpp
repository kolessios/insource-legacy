...
CLoading_Panel *g_pLoading_Panel = NULL;

CUtlVector<CLoading_Panel *> g_vecLoadingPanels;

//================================================================================
// Devuelve el panel de carga de nivel
//================================================================================
CLoading_Panel *GetLoadingPanel()
{
	if ( NULL == g_pLoading_Panel )
	{
		g_pLoading_Panel = new CLoading_Panel();
	}
	return g_pLoading_Panel;
}
...
void DestroyLoadingPanel()
{
	if ( NULL != g_pLoading_Panel )
	{
		delete g_pLoading_Panel;
		g_pLoading_Panel = NULL;
	}
}
...
// Constructor
//================================================================================
CLoading_Panel::CLoading_Panel() : BaseClass( NULL, "SDK_Loading_Panel", vgui::scheme()->LoadSchemeFromFile( "Resource/ClientScheme.res", "ClientScheme" ) )
{
	Init();
}
...
// Constructor
//================================================================================
CLoading_Panel::CLoading_Panel( vgui::Panel *parent ) : BaseClass( parent, "TFStatsSummary", vgui::scheme()->LoadSchemeFromFile( "Resource/ClientScheme.res", "ClientScheme" ) )
{
	Init();
}
...
//================================================================================
//================================================================================
void CLoading_Panel::PerformLayout()
{
...
//================================================================================
//================================================================================
void CLoading_Panel::ApplySchemeSettings(vgui::IScheme *pScheme)
{
...
//================================================================================
//================================================================================
void CLoading_Panel::GetLoadingScreenSize(int &w, int &t, int &xoffset)
{
	int sw, sh;
	vgui::surface()->GetScreenSize( sw, sh );
...
//================================================================================
//================================================================================
void CLoading_Panel::FireGameEvent( IGameEvent *event )
{
...
//================================================================================
//================================================================================
void CLoading_Panel::SetLoadingMapName( const char *szMapName )
{
	m_pDetailsPanel->SetVisible( false );
...
//================================================================================
//================================================================================
void CLoading_Panel::SetGenerationOptions( KeyValues *pKeys )
{
