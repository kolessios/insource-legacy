...
CBackground_Movie *g_pBackgroundMovie = NULL;

//================================================================================
// Devuelve la ruta al vídeo que debe aparecer ahora mismo (Sin las reglas)
// @TODO: Poder editar esto sin tocar el código
//================================================================================
const char *GetFilenameMovie() 
{
#ifdef SCP
#ifdef ASW_BINK_MOVIES
    return "media/logo.bik";
#else
    return "media/logo.avi";
#endif
#endif

	return "media/l4d2_background04.bik";
}

//================================================================================
// Función global para obtener el panel que reproduce el vídeo de fondo
//================================================================================
CBackground_Movie* GetBackgroundMovie()
{
	// Si no existe, lo creamos
	if ( !g_pBackgroundMovie )
		g_pBackgroundMovie = new CBackground_Movie();
...
// Constructor
//===============================================================================
CBackground_Movie::CBackground_Movie()
{
	#ifdef ASW_BINK_MOVIES
...
//================================================================================
// Establece el vídeo que debe reproducirse en el panel
//================================================================================
void CBackground_Movie::SetCurrentMovie( const char *szFilename )
{
...
//================================================================================
// Elimina el vídeo actual del panel
//================================================================================
void CBackground_Movie::ClearCurrentMovie()
{
	#ifdef ASW_BINK_MOVIES
		if ( m_nBIKMaterial != BIKMATERIAL_INVALID )
		{
...
//================================================================================
//================================================================================
int CBackground_Movie::SetTextureMaterial()
{
	#ifdef ASW_BINK_MOVIES
		if ( m_nBIKMaterial == BIKMATERIAL_INVALID )
			return -1;
...
//================================================================================
// Actualiza el vídeo actual
//================================================================================
void CBackground_Movie::Update()
{
	int nMovieState = 0;
	const char *pMovie = GetFilenameMovie();

	if ( TheGameRules )
	{
		pMovie = TheGameRules->GetBackgroundMovie();
	}
	else
	{
		nMovieState = 1;
	...
	if ( m_nLastGameState != nMovieState  )
	{
		if ( pMovie )
			SetCurrentMovie( pMovie );

		m_nLastGameState = nMovieState;
	}

	/*
	if ( engine->IsConnected() && TheGameRules )
	{
...
void CNB_Header_Footer::PaintBackground()
{
	...
	if ( m_bMovieEnabled && GetBackgroundMovie() )
	{
		GetBackgroundMovie()->Update();
		if ( GetBackgroundMovie()->SetTextureMaterial() != -1 )
		{
