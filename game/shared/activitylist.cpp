...
void ActivityList_RegisterSharedActivities( void )
{
	...
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_DEPLOY_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_EMPTY );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_EMPTY_LAYER );
...
//===========================
	...
	REGISTER_SHARED_ACTIVITY ( ACT_MP_DEPLOY );
	...
	// InSource/Left 4 Dead 2
	REGISTER_SHARED_ACTIVITY( ACT_MP_IDLE_CALM );
	REGISTER_SHARED_ACTIVITY( ACT_MP_IDLE_INJURED );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_CALM );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_INJURED );
	REGISTER_SHARED_ACTIVITY( ACT_MP_WALK_CALM );
	REGISTER_SHARED_ACTIVITY( ACT_MP_WALK_INJURED );

	REGISTER_SHARED_ACTIVITY( ACT_IDLE_CALM_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_INJURED_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CALM_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_INJURED_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_CALM_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_INJURED_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_CROUCHIDLE_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CROUCH_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARYATTACK_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_DEPLOY_PISTOL );
	...
	REGISTER_SHARED_ACTIVITY( ACT_DEPLOY_SMG );

	REGISTER_SHARED_ACTIVITY( ACT_IDLE_CALM_RIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_INJURED_RIFLE );	
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CALM_RIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_INJURED_RIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_CALM_RIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_INJURED_RIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_CROUCHIDLE_RIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARYATTACK_RIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_DEPLOY_RIFLE );

	REGISTER_SHARED_ACTIVITY( ACT_IDLE_CALM_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_INJURED_SHOTGUN );	
	REGISTER_SHARED_ACTIVITY( ACT_RUN_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CALM_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_INJURED_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_CALM_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_INJURED_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_CROUCHIDLE_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CROUCH_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARYATTACK_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_DEPLOY_SHOTGUN );

    REGISTER_SHARED_ACTIVITY( ACT_IDLE_SNIPER );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_CALM_SNIPER );	
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_INJURED_SNIPER );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_SNIPER );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CALM_SNIPER );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_INJURED_SNIPER );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_SNIPER );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_CALM_SNIPER );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_INJURED_SNIPER );
	REGISTER_SHARED_ACTIVITY( ACT_CROUCHIDLE_SNIPER );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CROUCH_SNIPER );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARYATTACK_SNIPER );
    REGISTER_SHARED_ACTIVITY( ACT_RELOAD_SNIPER );
    REGISTER_SHARED_ACTIVITY( ACT_DEPLOY_SNIPER );

	REGISTER_SHARED_ACTIVITY( ACT_IDLE_INCAP_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_INCAP_ELITES );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_INCAP_TO_STAND );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_INCAP_CRAWL );

	REGISTER_SHARED_ACTIVITY( ACT_TERROR_FALL_GRAB_LEDGE );
	...
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_ATTACK_DOOR_CONTINUOUSLY );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_ATTACK_CONTINUOUSLY );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_UNABLE_TO_REACH_TARGET );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_STADING_ON_FIRE );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_RUN_ON_FIRE );

	REGISTER_SHARED_ACTIVITY( ACT_TERROR_FLINCH );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_FLINCH_LEDGE );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_FIDGET );

    REGISTER_SHARED_ACTIVITY( ACT_CROUCH_PANICKED );
    REGISTER_SHARED_ACTIVITY( ACT_DI_HUNTER_MELEE );

    REGISTER_SHARED_ACTIVITY( ACT_VM_MELEE );
	REGISTER_SHARED_ACTIVITY( ACT_VM_MELEE_LAYER );
    REGISTER_SHARED_ACTIVITY( ACT_VM_HELPINGHAND_EXTEND );
    REGISTER_SHARED_ACTIVITY( ACT_VM_HELPINGHAND_LOOP );
    REGISTER_SHARED_ACTIVITY( ACT_VM_HELPINGHAND_RETRACT );
    REGISTER_SHARED_ACTIVITY( ACT_VM_ITEMPICKUP_EXTEND );
    REGISTER_SHARED_ACTIVITY( ACT_VM_ITEMPICKUP_LOOP );
    REGISTER_SHARED_ACTIVITY( ACT_VM_ITEMPICKUP_RETRACT );
    REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_LOOP );
    ...
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_SIGNAL_FORWARD );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_SIGNAL_HALT );
    REGISTER_SHARED_ACTIVITY( ACT_GMOD_SIGNAL_GROUP );
