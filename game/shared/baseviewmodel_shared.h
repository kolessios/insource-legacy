...
public:
	...
	virtual void			SendViewModelMatchingSequenceLayer( int sequence );
    ...
    void SetOwnerViewModel( CBaseViewModel *pViewmodel );
	void					SetIndex( int nIndex );
	// Returns which viewmodel it is
	int						ViewModelIndex( ) const;

	virtual const char *GetWeaponModel() { return STRING(m_sVMName); }
    ...
    virtual CBaseViewModel *GetViewModel()
    {
        return m_hOwnerViewModel;
    }
...
// FTYPEDESC_INSENDTABLE STUFF (end)
    ...
    CNetworkHandle( CBaseViewModel, m_hOwnerViewModel );
