...
public:
	...
	void				AddAmmoType(char const* name, int damageType, int tracerType, char const* plr_cvar, char const* npc_var, char const* carry_cvar, float physicsForceImpulse, float bulletSpeed, int nFlags, int minSplashSize = 4, int maxSplashSize = 8 );
