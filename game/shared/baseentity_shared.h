...
enum ExclusiveVisibility_t
{
    VISIBILITY_EXCLUSIVE_NONE = 0,
    VISIBILITY_EXCLUSIVE_REFLECTION,
    VISIBILITY_EXCLUSIVE_SHADOWS,
    VISIBILITY_EXCLUSIVE_MONITORS,
    VISIBILITY_EXCLUSIVE_REFLECTION_AND_SHADOWS,
    VISIBILITY_EXCLUSIVE_ALL
};
