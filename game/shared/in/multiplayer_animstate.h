...
struct MultiPlayerMovementData_t
{
    ...
    const char *m_nMoveXPoseName;
    const char *m_nMoveYPoseName;
    const char *m_nAimPitchPoseName;
    const char *m_nAimYawPoseName;
    const char *m_nMoveYawPoseName;
    const char *m_nMoveScalePoseName;

    LegAnimType_t m_iLegsAnimType;
    ...
    void Init()
    {
        ...
        m_flSprintSpeed = -1;
        m_flBodyYawRate = -1;
        m_iLegsAnimType = LEGANIM_9WAY;

        m_nMoveXPoseName       = "move_x";
        m_nMoveYPoseName       = "move_y";
        m_nAimPitchPoseName    = "body_pitch";
        m_nAimYawPoseName      = "body_yaw";
        m_nMoveYawPoseName     = "move_yaw";
        m_nMoveScalePoseName   = "move_scale";
    }
};
