...
#endif
{
    ...
    m_LegAnimType = m_MovementData.m_iLegsAnimType;
...
//        RestartGestureSequence( nData, false );
    ...
    case PLAYERANIMEVENT_FLINCH:
        PlayFlinchGesture( ACT_MP_GESTURE_FLINCH );
        break;
...
bool CMultiPlayerAnimState::SetupPoseParameters( CStudioHdr *pStudioHdr )
{
    ...
    m_PoseParameterData.m_iMoveX = GetBasePlayer()->LookupPoseParameter( pStudioHdr, m_MovementData.m_nMoveXPoseName );
    m_PoseParameterData.m_iMoveY = GetBasePlayer()->LookupPoseParameter( pStudioHdr, m_MovementData.m_nMoveYPoseName );
    /*
    ...
    */
    ...
    m_PoseParameterData.m_iAimPitch = GetBasePlayer()->LookupPoseParameter( pStudioHdr, m_MovementData.m_nAimPitchPoseName );
    /*
    ...
    */
    ...
    m_PoseParameterData.m_iAimYaw = GetBasePlayer()->LookupPoseParameter( pStudioHdr, m_MovementData.m_nAimYawPoseName );
    /*
    if ( m_PoseParameterData.m_iAimYaw < 0 )
        return false;
    */

    m_PoseParameterData.m_iMoveYaw = GetBasePlayer()->LookupPoseParameter( pStudioHdr, m_MovementData.m_nMoveYawPoseName );
    m_PoseParameterData.m_iMoveScale = GetBasePlayer()->LookupPoseParameter( pStudioHdr, m_MovementData.m_nMoveScalePoseName );
    /*
...
void CMultiPlayerAnimState::ComputePoseParam_AimYaw( CStudioHdr *pStudioHdr )
{
    ...
    if ( m_flGoalFeetYaw != m_flCurrentFeetYaw )
    {
        ...
        {
            ConvergeYawAngles( m_flGoalFeetYaw, m_MovementData.m_flBodyYawRate, gpGlobals->frametime, m_flCurrentFeetYaw );
