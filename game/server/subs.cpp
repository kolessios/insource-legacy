...
LINK_ENTITY_TO_CLASS( info_player_soldier, CPointEntity );

#ifdef SCP
LINK_ENTITY_TO_CLASS( info_player_scp173, CPointEntity );
LINK_ENTITY_TO_CLASS( info_player_scp096, CPointEntity );
LINK_ENTITY_TO_CLASS( info_player_scp035, CPointEntity );
LINK_ENTITY_TO_CLASS( info_player_scp049, CPointEntity );
LINK_ENTITY_TO_CLASS( info_player_scp106, CPointEntity );
LINK_ENTITY_TO_CLASS( info_player_scp4579, CPointEntity );
#endif
