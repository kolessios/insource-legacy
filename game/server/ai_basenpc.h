...
protected:
	...
	virtual void RunAttackTask( int task );
...
{
	return GetCharacter()->GetHullType();
}
...
{
	return NAI_Hull::TraceMask(GetCharacter()->GetHullType());
}
...
{
	return GetCharacter()->GetIdealSpeed();
}
...
{
	return GetCharacter()->GetIdealAccel();
}
...
{
	return GetCharacter()->GetSequence();
}
...
{
	GetCharacter()->RemoveFlag( flagsToRemove );
}
...
{
	GetCharacter()->SetGroundEntity( ground );
}
...
{
	GetCharacter()->ToggleFlag( flagToToggle );
}
...
{
	return GetCharacter()->GetClassname();
}
...
{
	GetCharacter()->SetLocalAngles( angles );
}
...
{
	return GetCharacter()->GetLocalAngles();
}
...
{
	return GetCharacter()->NetworkProp()->edict();
}
...
{
	return GetCharacter()->GetLastThink( szContext );
}
