...
public:
	...
	~CPlayerInfo () {}
	virtual void SetParent( CBasePlayer *parent ) { m_pParent = parent; } 
...
public:
	...
	virtual void	SetConnected( PlayerConnectedState iConnected ) { m_iConnected = iConnected; }
...
public:
    ...
    float		GetDeathAnimTime( void ) { return m_flDeathAnimTime; }
