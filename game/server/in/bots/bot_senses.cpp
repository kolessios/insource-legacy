...
{
	VPROF_BUDGET("OnLooked", VPROF_BUDGETGROUP_BOTS_EXPENSIVE);
...
{
	VPROF_BUDGET("CBot::OnLooked::Entity", VPROF_BUDGETGROUP_BOTS_EXPENSIVE);
...
{
	VPROF_BUDGET("OnListened", VPROF_BUDGETGROUP_BOTS_EXPENSIVE);
