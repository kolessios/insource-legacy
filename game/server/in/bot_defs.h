...
enum
{
	...
	BTASK_SAVE_LOCATION,                // Guardar nuestra posición actual
	BTASK_RESTORE_LOCATION,             // Restaurar la posición guardada
	...
	BTASK_RUN,                          // Correr
    BTASK_WALK,                         // Caminar (lento) No funciona si esta corriendo
	BTASK_WALK_NORMAL,                  // Dejar de correr y caminar
