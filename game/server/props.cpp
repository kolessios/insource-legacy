...
{
	if ( CanObstructNavAreas() )	// tank walls have a different behavior
	{
...
void CPhysicsProp::NavThink( void )
{
    ...
    SetNextThink( gpGlobals->curtime + 1.0f, "NavContext" );
}
...
void CPropDoorRotating::BeginOpening(CBaseEntity *pOpenAwayFrom)
{
	...
	{
		CSoundEnt::InsertSound( SOUND_WORLD | SOUND_CONTEXT_DOOR, volumeCenter, volumeRadius, 0.5f, pOpenAwayFrom );
	}
