...
void CAI_BaseNPC::InitDefaultActivitySR(void) 
{
	...
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_DEPLOY_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_EMPTY );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_EMPTY_LAYER );
...
//===========================
	...
	ADD_ACTIVITY_TO_SR( ACT_MP_DEPLOY );
	...
	ADD_ACTIVITY_TO_SR( ACT_MP_IDLE_CALM );
	ADD_ACTIVITY_TO_SR( ACT_MP_IDLE_INJURED );
	ADD_ACTIVITY_TO_SR( ACT_MP_RUN_CALM );
	ADD_ACTIVITY_TO_SR( ACT_MP_RUN_INJURED );
	ADD_ACTIVITY_TO_SR( ACT_MP_WALK_CALM );
	ADD_ACTIVITY_TO_SR( ACT_MP_WALK_INJURED );

	ADD_ACTIVITY_TO_SR( ACT_IDLE_CALM_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_INJURED_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CALM_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_RUN_INJURED_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_WALK_CALM_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_WALK_INJURED_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_CROUCHIDLE_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CROUCH_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_PRIMARYATTACK_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_DEPLOY_PISTOL );
	...
	ADD_ACTIVITY_TO_SR( ACT_DEPLOY_SMG );

	ADD_ACTIVITY_TO_SR( ACT_IDLE_CALM_RIFLE );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_INJURED_RIFLE );	
	ADD_ACTIVITY_TO_SR( ACT_RUN_CALM_RIFLE );
	ADD_ACTIVITY_TO_SR( ACT_RUN_INJURED_RIFLE );
	ADD_ACTIVITY_TO_SR( ACT_WALK_CALM_RIFLE );
	ADD_ACTIVITY_TO_SR( ACT_WALK_INJURED_RIFLE );
	ADD_ACTIVITY_TO_SR( ACT_CROUCHIDLE_RIFLE );
	ADD_ACTIVITY_TO_SR( ACT_PRIMARYATTACK_RIFLE );
	ADD_ACTIVITY_TO_SR( ACT_DEPLOY_RIFLE );

	ADD_ACTIVITY_TO_SR( ACT_IDLE_CALM_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_INJURED_SHOTGUN );	
	ADD_ACTIVITY_TO_SR( ACT_RUN_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CALM_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_RUN_INJURED_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_WALK_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_WALK_CALM_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_WALK_INJURED_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_CROUCHIDLE_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CROUCH_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_PRIMARYATTACK_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_DEPLOY_SHOTGUN );

    ADD_ACTIVITY_TO_SR( ACT_IDLE_SNIPER );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_CALM_SNIPER );	
	ADD_ACTIVITY_TO_SR( ACT_IDLE_INJURED_SNIPER );
	ADD_ACTIVITY_TO_SR( ACT_RUN_SNIPER );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CALM_SNIPER );
	ADD_ACTIVITY_TO_SR( ACT_RUN_INJURED_SNIPER );
	ADD_ACTIVITY_TO_SR( ACT_WALK_SNIPER );
	ADD_ACTIVITY_TO_SR( ACT_WALK_CALM_SNIPER );
	ADD_ACTIVITY_TO_SR( ACT_WALK_INJURED_SNIPER );
	ADD_ACTIVITY_TO_SR( ACT_CROUCHIDLE_SNIPER );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CROUCH_SNIPER );
	ADD_ACTIVITY_TO_SR( ACT_PRIMARYATTACK_SNIPER );
    ADD_ACTIVITY_TO_SR( ACT_RELOAD_SNIPER );
    ADD_ACTIVITY_TO_SR( ACT_DEPLOY_SNIPER );

	ADD_ACTIVITY_TO_SR( ACT_IDLE_INCAP_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_IDLE_INCAP_ELITES );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_INCAP_TO_STAND );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_INCAP_CRAWL );

	ADD_ACTIVITY_TO_SR( ACT_TERROR_FALL_GRAB_LEDGE );
	...
	ADD_ACTIVITY_TO_SR( ACT_TERROR_ATTACK_DOOR_CONTINUOUSLY );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_ATTACK_CONTINUOUSLY );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_UNABLE_TO_REACH_TARGET );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_STADING_ON_FIRE );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_RUN_ON_FIRE );

	ADD_ACTIVITY_TO_SR( ACT_TERROR_FLINCH );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_FLINCH_LEDGE );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_FIDGET );

    ADD_ACTIVITY_TO_SR( ACT_CROUCH_PANICKED );
    ADD_ACTIVITY_TO_SR( ACT_DI_HUNTER_MELEE );

    ADD_ACTIVITY_TO_SR( ACT_VM_MELEE );
	ADD_ACTIVITY_TO_SR( ACT_VM_MELEE_LAYER );
    ADD_ACTIVITY_TO_SR( ACT_VM_HELPINGHAND_EXTEND );
    ADD_ACTIVITY_TO_SR( ACT_VM_HELPINGHAND_LOOP );
    ADD_ACTIVITY_TO_SR( ACT_VM_HELPINGHAND_RETRACT );
    ADD_ACTIVITY_TO_SR( ACT_VM_ITEMPICKUP_EXTEND );
    ADD_ACTIVITY_TO_SR( ACT_VM_ITEMPICKUP_LOOP );
    ADD_ACTIVITY_TO_SR( ACT_VM_ITEMPICKUP_RETRACT );
    ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_LOOP );
    ...
    ADD_ACTIVITY_TO_SR( ACT_GMOD_SIGNAL_FORWARD);
    ADD_ACTIVITY_TO_SR( ACT_GMOD_SIGNAL_HALT);
    ADD_ACTIVITY_TO_SR( ACT_GMOD_SIGNAL_GROUP);
