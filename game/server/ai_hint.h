...
enum Hint_e
{
	...
	HINT_WORLD_WINDOW = 100,
	HINT_WORLD_HEAT_SOURCE,
	HINT_WORLD_HUMAN_BLOOD,
	HINT_WORLD_BLOOD,
    HINT_WORLD_DARK_SPOT,

	HINT_WORLD_VISUALLY_INTERESTING = 200,
	HINT_WORLD_VISUALLY_INTERESTING_DONT_AIM,
	HINT_WORLD_VISUALLY_INTERESTING_STEALTH,
    	
	HINT_TACTICAL_COVER	= 300,
	HINT_TACTICAL_PINCH,
	HINT_TACTICAL_DISADVANTAGED_POINT,
	HINT_TACTICAL_HIGH_GROUND,
    HINT_TACTICAL_VISUALLY_INTERESTING,
    HINT_TACTICAL_ASSAULT_APPROACH,
    HINT_TACTICAL_AREA,

    HINT_FOLLOW_WAIT_POINT = 800,
    HINT_JUMP_OVERRIDE
};
